...
@file    :   p04trainandtest.py
@version :   1.0
@author  :   NUIST-LEE
@time    :   2023-1-24 19:19
@description:
模型训练和测试-ANN类型模型的训练
'''
...
class AreaModelTrainTest():
    ...
    # 训练和测试过程
    def train_test(self):
        model = ANNModel(input_dims=self.input_dim, output_dims=self.output_dim, layers=self.num_layers,
                         hiddens=self.hidden_dim, activation=self.activation,
